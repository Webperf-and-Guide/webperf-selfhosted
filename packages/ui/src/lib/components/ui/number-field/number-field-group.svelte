<script lang="ts">
	import { cn, type WithElementRef } from '@webperf/ui/utils';
...
<div
	bind:this={ref}
	class={cn(
		'flex h-10 items-center overflow-hidden rounded-[var(--wp-radius-sm)] border border-line/80 bg-surface-strong/70 shadow-[var(--wp-shadow-soft)]',

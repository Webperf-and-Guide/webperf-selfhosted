...
- the Lighthouse reference runner now normalizes every mapped-IPv4 form, blocks NAT64/Teredo/6to4 ranges, bounds DNS and CONNECT idle time, strips forwarded identity headers, emits bounded safe proxy diagnostics, verifies uploaded artifact digests, and pins the amd64 Chrome revision explicitly

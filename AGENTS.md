...
- local Browser Audit artifact operations now pin validated, process-owned audit directories across downloads and deletes, reject directory identity changes, and document the API-only Compose volume boundary

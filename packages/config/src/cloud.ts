...
export const edgeControlVarsSchema = z.object({
  ...
  BUNNY_PROBE_IMAGE: z.string().min(1).default('ghcr.io/webperf-and-guide/webperf-probe:main'),
  ...
  BUNNY_BROWSER_AUDIT_IMAGE: z.string().min(1).default('ghcr.io/webperf-and-guide/webperf-browser-audit-worker:main'),

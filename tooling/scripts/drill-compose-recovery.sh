...
compose run --rm --no-deps --user 1000:1000 --entrypoint bun webperf \
...
compose run --rm --no-deps --user 1000:1000 --entrypoint rm webperf \
  -f "$backup_inside_volume"
...
compose run -T --rm --no-deps --user 1000:1000 --entrypoint sh webperf \
